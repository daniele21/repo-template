...
This folder contains the privacy and GDPR governance artifacts that sit on top of the baseline privacy rules.
...
- [lawful-basis-matrix.md](./lawful-basis-matrix.md)
- [retention-policy.md](./retention-policy.md)
- [data-subject-rights.md](./data-subject-rights.md)
- [end-of-contract-data-handling.md](./end-of-contract-data-handling.md)
